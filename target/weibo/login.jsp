	...
	<div class="MB_wrap">
		...
		<div class="login_body">
							...
							<dd>
								<ul class="userlist">
									<c:forEach items="${newcomList}" var="ncm">
										<li><img title="${ncm.nickName}" src="${ncm.myFace}" />
											<a href="" title="${ncm.nickName}"> ${ncm.nickName} </a></li>
									</c:forEach>
								</ul>
							</dd>
						</dl>
							...
							<dd>
								<ul class="userlist">
									<c:forEach items="${famousList}" var="fms">
										<li><img title="${fms.nickName}" src="${fms.myFace}" />
											<a href="" title="${fms.nickName}"> ${fms.nickName} </a></li>
									</c:forEach>
								</ul>
							</dd>
						</dl>
			...
			<div class="login_r">
				<div class="login_item">
					<div class="regtop">
						<a href="regist.jsp" target="_blank" class="regbtn" title="立即注册微博"
							tabindex="7"> </a>
					</div>
						...
						<div class="loginform" id="login_form">
							<div class="input_bg">
								<input type="text" id="loginname" name="login.loginName"
									title="登录名" tabindex="1" onfocus="clearLogin(id);"
									value="请输入登陆名称" autocomplete="off" />
							</div>
							<div class="input_bg">
								<input type="text" id="password_text" tabindex="1" title="密码"
									onfocus="clearPassword();" value="请输入密码" /> <input
									type="password" id="password" name="login.password"
									tabindex="1" title="密码" onblur="recoverPassword();"
									style="display: none;" />
							</div>
							<div id="door_p" style='display: none'>
								<div class="inputcodeM">
									<span class="input_code"> <input type="text" id="door"></span>
							...
							<div class="setting">
								<span class="lf"> <input type="checkbox" class="labelbox"
									id="remusrname" checked /> <label for="remusrname">
										下次自动登录 </label>
								</span> <a class="rt" href="/Weibo/Admin/getPwd.action" target="_blank"
									tabindex="4"> 找回密码 </a>
							</div>
							<div class="signin">
								<a href="javascript:void(0);" onclick="toSubmit('login');"
									class="sp" id="login_submit_btn" tabindex="2"> </a>
							</div>
							<div align="center">
								<br> <br> <br>
		...
		<div class="bodybt">
			<div class="MIB_foot_new MIB_txtbr MIB_linkbr"
				...
				<p>
					Copyright © 2011-2013<a href="http://weibo.com/yooungt">有田十三</a>All
					Rights Reserved.
				</p>
				<p></p>
			</div>
