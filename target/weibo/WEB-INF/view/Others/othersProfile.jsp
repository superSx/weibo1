...
<head>
	...
	<link href="css/artZoom.css" type="text/css" rel="stylesheet"/>
	
	<script type="text/javascript" src="js/jquery-1.3.2.min.js" ></script>
	<script type="text/javascript" src="js/artZoom.js"></script>
	<script type="text/javascript" src="js/json.js"></script>
	<script type="text/javascript" src="js/index.js"></script>
	<script type="text/javascript" src="js/comment.js"></script>
	<script type="text/javascript" src="js/favors_manage.js"></script>
	<script type="text/javascript" src="js/transmit_manage.js"></script>
	<script type="text/javascript" src="js/editor_manage.js"></script>
	<script type="text/javascript" src="js/fans_manage.js"></script>  
			...
			<div class="tsina_gnbarea" id="">
	            ...
	            <div class="tsina_gnb">
	  				<ul class="gnb_r">
	                    ...
	                    <li><a href="frommsgList.action?pageNumber=1">私信</a> </li>
	                    <li><a href="systemList.action?pageNumber=1">通知</a> </li>
	                    <li><a href="Setting/Setting.action">帐号设置</a> </li>
	                    <li class="line">|</li>
						<li><a id="" href="exitLogin.action">退出</a> </li>
	                </ul>
	            </div>
	        </div>
	        <!-- 小黄签 -->
		...
		<div class="header">
		  <div class="head_menu">
				...
				<div class="menu_c">
					...
					<ul>
						<li><a href="Page.action?pageNumber=1">我的首页</a></li>
		                <li class="line">|</li><li><a href="myProfPage.action?pageNumber=1">我的微博</a></li>
		                <li class="line">|</li><li><a href="MyBlog/myFollowpage.action?pageNumber=1&listType=2">好友</a></li>
					</ul>
							...
							<div class="user_atten MIB_linedot">
								<ul id="profile_following_follower_update">
									<li id="pop_2" class="MIB_line_r">
										<div class="num" pop="true"><a href="Others/othersFollow.action?otherId=${other.userId }" id="mblog">${other.followCount}</a></div>
										<a href="Others/othersFollow.action?otherId=${other.userId }">关注</a>
									</li>
									<li class="MIB_line_r">
										<div class="num"><a href="Others/othersFans.action?otherId=${other.userId }" id="myfans">${other.fansCount}</a></div>
										<a href="Others/othersFans.action?otherId=${other.userId }">粉丝</a>
									</li>
									<li class="">
										<div class="num"><a href="Others/othersProfile.action?otherId=${other.userId }" id="mblog">${other.profileCount}</a></div>
										<a href="Others/othersProfile.action?otherId=${other.userId }">微博</a>
									</li>
								</ul>
							</div>
						...
						<div wbml="widget" name="app11">
							...
							<div class="f_pro">
								<div class="title font_14 MIB_linkcr">${other.nickName}的标签</div>
									...
									<div class="txt_right">
										<a href="MyBlog/initSearch.action">标签搜索</a>
									</div>
								</div>
								<!--/标签-->						
						</div>
						...
						<div wbml="widget" name="app9">
							...
							<div class="f_pro">
								...
								<ul class="user_recom" style="overflow-x: hidden;">
									...
									<li>
										<a href="Others/othersProfile.action?otherId=${fans.userId}" title="${fans.nickName}">
											<img namecard="true" src="${fans.myFace}" style="width:50px; height:50px;" >
										</a>
										<div class="name">
											<a namecard="true" href="Others/othersProfile.action?otherId=${fans.userId}" title="${fans.nickName}">${fans.nickName}</a>
										</div>
									</li>
									</c:forEach>							
								</ul>
								<div class="txt_right" style="padding-bottom:50px;">
									<c:if test="${other.fansCount > 9}">
										<a href="Others/othersFans.action?otherId=${other.userId }">更多<em>&gt;&gt;</em></a>
									</c:if>
								</div>
							</div>
							<!--/ 某人的粉丝-->
					...
					<div class="mainL MIB_600 MIB_txtal MIB_linkal" id="profileL">
						...
						<div class="MIB_mbloghead" id="profileHead">
					    	<div class="MIB_mbloglist" id="profileHeadBg">
					            ...
					            <div class="other_info">
									...
									<p><a href="Others/othersInformationPage.action?otherId=${other.userId}">个人资料</a></p>					
						...
						<div class="MIB_mbloglist" id="profileFeed">
							<div class="newFilter MIB_txtal newFilterMb0">
								<div class="nfTagB nfTagOff">
									<ul>
										...
										<li ><a href="Others/othersInformationPage.action?otherId=${other.userId}">
										<c:choose>
											<c:when test="${other.sex == 1}">他的资料</c:when>
											<c:otherwise>她的资料</c:otherwise>									
										</c:choose></a></li>
								...
								<!-- /微博内容开始 -->
									<c:forEach items="${profList}" var="prof">
										<li class="MIB_linedot_l">			
										  	<div class="head_pic">
										  		<a namecard="true" href="Others/othersProfile.action?otherId=${prof.userinfo.userId}" ><img title="${prof.publishName}" imgtype="head" src="${prof.publishFace}"/></a>
											</div>
										  	<div class="MIB_feed_c">
												<p class="sms" type="1">
													<a namecard="true" href="Others/othersProfile.action?otherId=${prof.userinfo.userId}" title="${prof.publishName}">${prof.publishName}</a>：${prof.publishContent}
												</p>
							    				...
							    				<div class="MIB_assign">
							  						...
							  						<c:choose>
							  							...
							  							<c:otherwise>
													    <p class="source" mid="" type="2">
													    	<a href="Others/othersProfile.action?otherId=${prof.tsmit.userinfo.userId}" namecard="true" uid="">@${prof.tsmit.publishName}:</a>
													    	<span>${prof.tsmit.publishContent}</span>
														</p>
							    						<c:if test="${prof.tsmit.imageRef != null}">
															<div class="feed_preview" id="">
																<div class="feed_img">
																	<a href="MyBlog/profileContent.action?profId=${prof.tsmit.profId}">
																		<img src="Images/Refrences/${prof.tsmit.imageRef}" class="imgicon" onload="previewImage(this);" />
																	</a>
																</div>
																<div class="clear"></div>
															</div>
														...
														<div class="feed_att MIB_linkbl MIB_txtbl">
															<div class="lf">
																<cite><a href="MyBlog/profileContent.action?profId=${prof.tsmit.profId}"><strong>${prof.tsmit.subTime}</strong></a></cite> 
																<strong>来自</strong><cite><a href="Others/othersProfile.action?otherId=${prof.tsmit.userinfo.userId}" target="_blank">${prof.tsmit.publishName}</a></cite>
															</div>
															<div class="rt">
																<!-- 转发 -->
																<a href="MyBlog/profileContent.action?profId=${prof.tsmit.profId}" id="transmit_${prof.tsmit.profId}">
																	<strong>转发</strong>
												...
												<div class="feed_preview" id="">
													<div class="feed_img">
														<a class="miniImg artZoom" href="Images/Refrences/${prof.imageRef}" >
															<img src="Images/Refrences/${prof.imageRef}" class="imgicon small" style="max-width:240px; max-height:180px;"/>
														</a>
													</div>
													<div class="clear"></div>
												</div>
												...
												<div class="feed_att MIB_linkbl MIB_txtbl">					
													<div class="lf">
														<cite><a href="MyBlog/profileContent.action?profId=${prof.profId}"><strong>${prof.subTime}</strong></a></cite>
														<strong lang="CL1006">来自</strong><cite><a href="Others/othersProfile.action?otherId=${prof.userinfo.userId}" target="_blank"  onclick="">${prof.publishName}</a></cite>
													</div>
													<div class="rt">													
														<!-- 转发 -->
							...
							<div class="fanye MIB_txtbl" style="float:right;" id="page">
							    <a href="Others/othersProfile.action?otherId=${other.userId}&pageNumber=1" class="btn_num btn_numWidth"><em>首页</em></a>
							    <c:if test="${pageNumber>1}">  
							        <a href="Others/othersProfile.action?otherId=${other.userId}&pageNumber=${pageNumber-1})" class="btn_num btn_numWidth"><em>上一页</em></a>
							    </c:if>     
							    <c:forEach begin="1" end="5" step="1" var="pageIndex">  
	 								<c:if test="${pageNumber-(6-pageIndex) >=1}">   
							            <a class="btn_num" href="Others/othersProfile.action?otherId=${other.userId}&pageNumber=${pageNumber+pageIndex-6}"><em>${pageNumber+pageIndex-6}</em></a>
							        </c:if>  
								</c:forEach>
								<span>${pageNumber}</span>
								<c:forEach begin="1" end="5" step="1" var="pageIndex">  
	 								<c:if test="${pageNumber+pageIndex <= pageBean.totalPages}">  
							            <a class="btn_num"  href="Others/othersProfile.action?otherId=${other.userId}&pageNumber=${pageNumber+pageIndex}"><em>${pageNumber+pageIndex}</em></a>
							        </c:if>  
								</c:forEach>  
							    <c:if test="${pageNumber < pageBean.totalPages}">  
							        <a  href="Others/othersProfile.action?otherId=${other.userId}&pageNumber=${pageNumber+1}" class="btn_num btn_numWidth"><em>下一页</em></a>
							    </c:if>    
							    <a  href="Others/othersProfile.action?otherId=${other.userId}&pageNumber=${pageBean.totalPages}" class="btn_num btn_numWidth"><em>末页</em></a>
							</div>
							</c:if>
							</div>
							<!--翻页-->
	...
	<div style="">
		<div class="miniPopLayer" style="width:200px;">
			<div class="txt1 gray6">
				<img class="tipicon tip4" src="css/img/PY_ib.gif">
				<div>收藏成功</div>
			</div>
			<div style="" class="btn">
