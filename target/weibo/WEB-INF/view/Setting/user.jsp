        ...
        <div class="header">
		  <div class="head_menu">
				...
				<div class="menu_c">
					...
					<ul>
						<li class=""><a href="Page.action?pageNumber=1">我的首页</a></li>
				...
				<span class="menu_r">&nbsp;</span>
                    ...
                    <div class="MIB_blogbody">
                                    ...
                                    <div class="setup_main">
                                        <div class="infoTop">
                                            <div class="infoTop_nav">
                                                ...
                                                <span>
                                                    <a href="Setting/editpassword.jsp">
                                                        修改密码
                                                    </a>
                                                </span>
                                                <span class="navBorder gray9">
                                                ...
                                                <span>
                                                    <a href="Setting/educationinfo.jsp">
                                                        教育信息
                                                    </a>
                                                </span>
                                                <span class="navBorder gray9">
                        ...
                        <iframe frameborder="0" scrolling="no" width="800" src="Template/Copyright.jsp"></iframe>
                        <!--/找朋友-->
                    </div>
                    <!--/正文-->
                </div>
