		...
		<div class="userinfo">
		  <div class="user_atten MIB_linedot">
			<ul id="profile_following_follower_update">
				<li  class="MIB_line_r"><div class="num" pop="true"><a href="" id="attentions">${follows }</a></div>
			    <a href="follow.html">关注</a></li>
				<li class="MIB_line_r"><div class="num"><a href="" id="myfans">${fans}</a></div>
			    <a href="fans.html">粉丝</a></li>
			  <li class=""><div class="num"><a href="" id="mblog">${profiles }</a></div>
				<a href="profile.html">微博</a></li>
            </ul>
			<div class="f_pro">
			  <div class="title font_14 MIB_linkcr"><a href="myBlog.html" target="_blank">我的资料</a></div>
			  <ul class="con">
			    <li class="MIB_dot">${sessionScope.uInfo.SchoolName }</li>
		      </ul>
		    </div>
			<div class="f_pro">
              <div class="title font_14 MIB_linkcr"><a href="" target="_blank">${sessionScope.uInfo.nickName }的标签</a></div>
	          <ul class="con">
    	...
    	<div class="MIB_mbloglist" id="profileHeadBg">
            ...
            <div class="other_info">
				<div class="name MIB_txtal">
					<span class="lf">${sessionScope.uInfo.trueName}</span>
					<span class="aboutwho rt"><a id="publisher" href="Login"  onclick="">我要发微博</a></span>
				</div>
				<p><a href="setting">个人资料</a></p>
				<div class="ad MIB_txtbl">${sessionScope.uInfo.Province },${sessionScope.uInfo.City }</div>
    				...
    				<div class="MIB_assign">
  						...
  						<div class="MIB_assign_c MIB_txtbl"> 
							...
							<div class="feed_att MIB_linkbl MIB_txtbl">
								<div class="lf">
									<cite><a href=""  onclick=""><strong>${prof.profTime}</strong></a></cite> 
