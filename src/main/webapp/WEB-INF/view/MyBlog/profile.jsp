	    		...
	    		<div class="MIB_mblogbgl">
			        ...
			        <div class="mainR MIB_200 MIB_txtar MIB_linkar">
						...
						<div wbml="widget" name="app15">							
							<!--个人资料-->
							<div class="f_pro">
								<div class="title font_14 MIB_linkcr"><a href="/Weibo/MyBlog/myInformationPage.jsp">我的资料</a></div>
						...
						<div wbml="widget" name="app11">
							<!--标签-->
							<div class="f_pro">
								<div class="title font_14 MIB_linkcr"><a href="/Weibo/Setting/tag.jsp">${sessionScope.user.nickName}的标签</a></div>
									...
									<div class="txt_right">
										...
										<a href="/Weibo/Setting/tag.jsp" id="addUserTag">添加</a>
										<span class="MIB_liner">|</span>
										<a href="/Weibo/Setting/tag.jsp">管理<em>&gt;&gt;</em></a>
									</div>
								</div>
								<!--/标签-->						
						</div>
						...
						<div wbml="widget" name="app9">
							...
							<div class="f_pro">
								...
								<c:if test="${sessionScope.user.fansCount == 0}">
								<p style="color: #B8B7B7;padding:10px 5px;">还没有人关注你噢，去<a href="/Weibo/MyBlog/initSearch.action">找找朋友</a>。</p>
								</c:if>
								...
								<div class="txt_right"><c:if test="${sessionScope.user.fansCount > 9}"><a href="/Weibo/MyBlog/myFanspage.action?pageNumber=1&listType=1">更多<em>&gt;&gt;</em></a></c:if></div>
							</div>
							<!--/ 某人的粉丝-->
						</div>
					...
					<div class="mainL MIB_600 MIB_txtal MIB_linkal" id="profileL">
					    	...
					    	<div class="MIB_mbloglist" id="profileHeadBg">
					            ...
					            <div class="other_info">
									<div class="name MIB_txtal">
										...
										<span class="aboutwho rt"><a id="publisher" href="Page.action?pageNumber=1">我要发微博</a></span>
									</div>
						...
						<div class="MIB_mbloglist" id="profileFeed">
							<div class="newFilter MIB_txtal newFilterMb0">
								<div class="nfTagB nfTagOff">
									<ul>
										...
										<li ><a href="/Weibo/MyBlog/myInformationPage.jsp">我的资料</a></li>
									</ul>
									<div class="clear"></div>
								</div>
							</div>
							...
							<div style="color: #B8B7B7;padding: 30px 10px;">
								<p class="title">亲，您神马还没有留下，继续努力哦</p>
							</div>
							</c:if>
							...
							<ul class="MIB_feed onlytxt" id="feed_list">
								...
								<li class="MIB_linedot_l" id="myProf_${prof.profId}">
									<div class="MIB_feed_c">     
										<p class="sms" mid="" type="3">${prof.publishContent}</p>
										<!-- 转发微博内容 -->
					  						...
					  						<c:choose>
												...
												<div class="feed_att MIB_linkbl MIB_txtbl">
													<div class="lf">
														...
														<strong>来自</strong><cite><a href="/Weibo/Others/othersProfile.action?otherId=${prof.tsmit.userinfo.userId}">${prof.tsmit.publishName}</a></cite>
													</div>
													<div class="rt">
														<!-- 转发 -->
										...
										<div class="feed_att MIB_linkbl MIB_txtbl">
											<div class="lf">
												...
												<strong lang="CL1006">来自</strong><cite><a href="/Weibo/Others/othersProfile.action?otherId=${prof.userinfo.userId}">${prof.publishName}</a></cite>
											</div>
											<div class="rt">						
												<strong>							
													<a href="javascript:void(0);" id="${prof.profId}" onclick="setProfId(this);">
														<strong lang="CX0043">删除</strong>
													</a>
													<span class="MIB_line_l">|</span>
												</strong>
												<!-- 转发 -->
							...
							<div class="fanye MIB_txtbl" style="float:right;" id="page">
							    <a href="myProfPage.action?pageNumber=1" class="btn_num btn_numWidth"><em>首页</em></a>
							    <c:if test="${pageNumber>1}">  
							        <a href="myProfPage.action?pageNumber=${pageNumber-1}" class="btn_num btn_numWidth"><em>上一页</em></a>
							    </c:if>     
							    <c:forEach begin="1" end="5" step="1" var="pageIndex">  
	 								<c:if test="${pageNumber-(6-pageIndex) >=1}">   
							            <a class="btn_num" href="myProfPage.action?pageNumber=${pageNumber+pageIndex-6}"><em>${pageNumber+pageIndex-6}</em></a>
							        </c:if>  
								</c:forEach>
								<span>${pageNumber}</span>
								<c:forEach begin="1" end="5" step="1" var="pageIndex">  
	 								<c:if test="${pageNumber+pageIndex <= pageBean.totalPages}">  
							            <a class="btn_num"  href="myProfPage.action?pageNumber=${pageNumber+pageIndex}"><em>${pageNumber+pageIndex}</em></a>
							        </c:if>  
								</c:forEach>  
							    <c:if test="${pageNumber < pageBean.totalPages}">  
							        <a  href="myProfPage.action?pageNumber=${pageNumber+1}" class="btn_num btn_numWidth"><em>下一页</em></a>
							    </c:if>    
							    <a  href="myProfPage.action?pageNumber=${pageBean.totalPages}" class="btn_num btn_numWidth"><em>末页</em></a>
							</div>
							</c:if>
							</div>
							<!--翻页-->
