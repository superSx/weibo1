...
function initDate(){
	strYYYY = document.getElementById('birthday_y').outerHTML;
	strMM = document.getElementById('birthday_m').outerHTML;
	strDD = document.getElementById('birthday_d').outerHTML;
...
//先给年下拉框赋内容
	...
	document.getElementById('birthday_y').outerHTML = str+"</select>";
	...
	document.getElementById("birthday_m").outerHTML = str +'</select>';
	
	document.getElementById("birthday_y").value = y;
	document.getElementById("birthday_m").value = new Date().getMonth() + 1;
	var n = MonHead[new Date().getMonth()];
	if (new Date().getMonth() ==1 && IsPinYear(YYYYvalue)) n++;
	writeDay(n); //赋日期下拉框
	document.getElementById('birthday_d').value = new Date().getDate();
	}

function YYYYDD(str) //年发生变化时日期发生变化(主要是判断闰平年)
{
var MMvalue = document.getElementById('birthday_m').options[document.getElementById('birthday_m').selectedIndex].value;
...
{
var YYYYvalue = document.getElementById('birthday_y').options[document.getElementById('birthday_y').selectedIndex].value;
...
for (var i = 1; i <(n+1); i++)
	if( i < 10 ){
		...
		document.getElementById('birthday_d').outerHTML = s +"</select>";
}
function birthDay(){
	var YYYYvalue = document.getElementById('birthday_y').options[document.getElementById('birthday_y').selectedIndex].value;
	var MMvalue = document.getElementById('birthday_m').options[document.getElementById('birthday_m').selectedIndex].value;
	var DDvalue = document.getElementById('birthday_d').options[document.getElementById('birthday_d').selectedIndex].value;
	document.getElementById('Birthday').value=YYYYvalue+'-'+MMvalue+'-'+DDvalue;
}
