...
function OnClickSendMsg(){
	...
	var htmlList = '';
	htmlList += '<form id="msg" action="/weibo/sendMessage" method="post">';
    ...
    htmlList += '<th>私信内容：&nbsp;';
	htmlList += '</th>';
	htmlList += '<td><textarea id="popUpEditor" class="PY_input" name="msgContent" style="overflow-y:hidden; overflow-x: hidden; "></textarea>'; 
